...
void AddBlobImageToPresentation()
{
	...
	String pathToLargeImage = u"../templates/largeImage.jpg";

	// create a new presentation which will contain this image
	auto pres = System::MakeObject<Presentation>();

	auto fileStream = System::MakeObject<IO::FileStream>(pathToLargeImage, IO::FileMode::Open);
	...
	pres->Save(u"../out/presentationWithLargeImage.pptx", SaveFormat::Pptx);
