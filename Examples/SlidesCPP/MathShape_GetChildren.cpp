...
void ForEachMathElement(System::SharedPtr<IMathElement> root)
{
    ...
    {
        auto mathText = ObjectExt::Is<MathematicalText>(child) ? String(u" : ") + ExplicitCast<MathematicalText>(child)->get_Value() : u"";
...
void MathShape_GetChildren()
{
    ...
    auto mathParagraph = (System::AsCast<MathPortion>(portion))->get_MathParagraph();
