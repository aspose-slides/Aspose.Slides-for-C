...
void SetGapWidth()
{
	...
	const String outPath = L"../out/SetGapWidth_out.pptx";
	...
	SharedPtr<IChart> chart = slide->get_Shapes()->AddChart(Aspose::Slides::Charts::ChartType::StackedColumn, 0, 0, 500, 500);
