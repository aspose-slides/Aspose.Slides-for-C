...
void SettingInvertIfNegativePropertyForIndividualSeries()
{
	...
	series->get_DataPoints()->AddDataPointForBarSeries(fact->GetCell(0, u"B2", System::ObjectExt::Box<int32_t>(-5)));
	series->get_DataPoints()->AddDataPointForBarSeries(fact->GetCell(0, u"B3", System::ObjectExt::Box<int32_t>(3)));
	series->get_DataPoints()->AddDataPointForBarSeries(fact->GetCell(0, u"B4", System::ObjectExt::Box<int32_t>(-2)));
	series->get_DataPoints()->AddDataPointForBarSeries(fact->GetCell(0, u"B5", System::ObjectExt::Box<int32_t>(1)));
