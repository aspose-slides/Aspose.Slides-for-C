...
void SetDataLabelsPercentageSign()
{
	...
	SharedPtr<IChart> chart = slide->get_Shapes()->AddChart(ChartType::PercentsStackedColumn, 0, 0, 500, 500);
	...
	SharedPtr<IChartSeries> series=chart->get_ChartData()->get_Series()->Add(fact->GetCell(defaultWorksheetIndex, 0, 1, ObjectExt::Box<String>(u"Red")), chart->get_Type());
	...
	SharedPtr<IChartSeries> series2 = chart->get_ChartData()->get_Series()->Add(fact->GetCell(defaultWorksheetIndex, 0, 2, ObjectExt::Box<String>(u"Blues")), chart->get_Type());
	// Now populating series data
